! function(t, a, i, e) {
    ...
    r.prototype.onReset = function(t) {
        ...
        var e = a.data.variationForm,
            ...
            m = !1,
            l = "";
        if (i.sku ? r.wc_set_content(i.sku) : r.wc_reset_content(), i.weight ? n.wc_set_content(i.weight_html) : n.wc_reset_content(), i.dimensions ? s.wc_set_content(t.parseHTML(i.dimensions_html)[0].data) : s.wc_reset_content(), e.$form.wc_variations_image_update(i), i.variation_is_visible ? (m = o("variation-template"), i.variation_id) : m = o("unavailable-variation-template"), l = (l = (l = m({
                variation: i
            })).replace("/*<![CDATA[*/", "")).replace("/*]]>*/", ""), e.$singleVariation.html(l), e.$form.find('input[name="variation_id"], input.variation_id').val(i.variation_id).trigger("change"), "yes" === i.is_sold_individually) c.val("1").attr("min", "1").attr("max", "").trigger("change"), _.hide();
        else {
        ...
        i.useAjax || (i.$attributeFields.each(function(a, r) {
            ...
            o = d.find("option.attached").length, m && (l = !1, 0 !== o && d.find("option.attached.enabled").each(function() {
                var a = t(this).val();
                if (m === a) return l = !0, !1
            })), o > 0 && m && l && "no" === c && (d.find("option:first").remove(), _ = ""), d.find("option" + _ + ":not(.attached)").remove(), n.html(d.html()), n.find("option" + _ + ":not(.enabled)").prop("disabled", !0), m ? l ? n.val(m) : n.val("").trigger("change") : n.val("")
        ...
        this.$resetAlert.text(""), t ? "hidden" === this.$resetVariations.css("visibility") && (this.$resetVariations.css("visibility", "visible").hide().fadeIn(), this.$resetVariations.css("display", "inline-block")) : (this.$resetVariations.css("visibility", "hidden"), this.$resetVariations.css("display", "none"))
