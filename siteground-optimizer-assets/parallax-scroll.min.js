(function(e) {
    e(document).ready(function() {
        var t = {
            ...
            _onScroll: function(t) {
                ...
                this._log("onScroll " + n), e("[data-parallax]").each(e.proxy(function(o, i) {
                    ...
                    E && (a.z != void 0 && (j = l.perspective, j == null && (j = 800), b = r.parent(), b.data("style") || b.data("style", b.attr("style") || ""), b.attr("style", "perspective:" + j + "px; -webkit-perspective:" + j + "px; " + b.data("style"))), a.scaleX == void 0 && (a.scaleX = 1), a.scaleY == void 0 && (a.scaleY = 1), a.scaleZ == void 0 && (a.scaleZ = 1), a.scale != void 0 && (a.scaleX *= a.scale, a.scaleY *= a.scale, a.scaleZ *= a.scale), A = "translate3d(" + (a.x ? a.x : 0) + "px, " + (a.y ? a.y : 0) + "px, " + (a.z ? a.z : 0) + "px)", S = "rotateX(" + (a.rotateX ? a.rotateX : 0) + "deg) rotateY(" + (a.rotateY ? a.rotateY : 0) + "deg) rotateZ(" + (a.rotateZ ? a.rotateZ : 0) + "deg)", M = "scaleX(" + a.scaleX + ") scaleY(" + a.scaleY + ") scaleZ(" + a.scaleZ + ")", x = A + " " + S + " " + M + ";", this._log(x), r.attr("style", "transform:" + x + " -webkit-transform:" + x + " " + O))
        ...
        e(window).innerWidth() >= 1200 && t.init()
    })
})(jQuery)